...
export default function LoginPage() {
  ...
  return <div className="auth-page lms-auth-page">
    <section className="auth-showcase">
      <div className="auth-showcase-brand"><div className="auth-brand-logo">TVU</div><div><strong>TRƯỜNG ĐẠI HỌC TRÀ VINH</strong><span>Tra Vinh University</span></div></div>
    ...
    <section className="auth-login-panel"><div className="auth-card">
      <div className="auth-mobile-brand"><div className="auth-logo">TVU</div><strong>TRƯỜNG ĐẠI HỌC TRÀ VINH</strong></div>
