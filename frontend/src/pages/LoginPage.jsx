...
export default function LoginPage() {
  ...
  return <div className="login-page"><PublicHeader compact /><main className="login-main">
  ...
  </main><div className="login-footer">© 2026 Đại học Trà Vinh · TVU Student Project Portal</div></div>
}
