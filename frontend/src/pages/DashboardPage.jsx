...
export default function DashboardPage() {
  ...
  const stats = useMemo(() => {
    ...
    const assignedStudents = users.filter((user) => {
      ...
      return Boolean(
        user.ActiveClassId || user.ActiveClassCode || user.ActiveClassName
      );
    }).length;
  ...
  const getStatusClass = (isActive) => {
    return isActive === false ? "badge red" : "badge green";
  };
            ...
            <div
              ...
              style={{
                width:
                  stats.totalUsers === 0
                    ? "0%"
                    : `${(stats.totalActiveUsers / stats.totalUsers) * 100}%`,
              }}
            />
          </div>
            ...
            <div
              ...
              style={{
                width:
                  stats.totalUsers === 0
                    ? "0%"
                    : `${(stats.totalInactiveUsers / stats.totalUsers) * 100}%`,
              }}
            />
          </div>
        </div>
        ...
        <div className="table-card">
          ...
          <table className="modern-table">
            ...
            <tbody>
              ...
              {topClasses.length === 0 && (
                <tr>
                  <td colSpan="3">Chưa có dữ liệu lớp học.</td>
                </tr>
              )}
            </tbody>
          </table>
          ...
          <table className="modern-table">
            ...
            <tbody>
              ...
              {recentUsers.length === 0 && (
                <tr>
                  <td colSpan="3">Chưa có dữ liệu người dùng.</td>
                </tr>
              )}
            </tbody>
          </table>
