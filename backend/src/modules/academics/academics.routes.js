...
export const lecturerCourseClassRoutes=express.Router()
lecturerCourseClassRoutes.use(auth,role(USER_ROLES.LECTURER))
lecturerCourseClassRoutes.get('/',controller.lecturerList)
lecturerCourseClassRoutes.get('/:id',controller.lecturerDetail)
