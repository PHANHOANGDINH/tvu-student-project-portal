...
export const courseClassLecturerSchemas={
  AssignmentRole:{type:'string',enum:['LECTURER'],deprecated:true,description:'Field tương thích tạm thời; mọi giảng viên có quyền ngang nhau.'},
...
export const courseClassLecturerPaths={
  ...
  '/admin/course-classes/{courseClassId}/lecturers/{lecturerId}':{
    ...
    delete:{...secure,summary:'Gỡ phân công',description:'Lớp có thể tạm thời chưa phân công giảng viên.',parameters:[id('courseClassId'),id('lecturerId')],responses:{200:{description:'Đã gỡ'},401:error,403:error,404:error}},
  },
}
